...
DEST = [
    ...
    ('male',4.175,73.509),
    ('mauritius',-20.274,57.363),
    ('mahe',-4.62,55.45),
    ('praslin',-4.318,55.74),
    ('sansibar',-5.726,39.297),
    ('diani',-4.279,39.591),
    ('mombasa',-4.043,39.668),
    ('nosybe',-13.32,48.26),
    ('bentota',6.42,79.995),
    ('mirissa',5.945,80.459),
    ('goa',15.55,73.75),
    ('phuket',7.888,98.298),
    ('krabi',8.032,98.822),
    ('khaolak',8.639,98.245),
    ('kohsamui',9.512,100.061),
    ('kohphangan',9.733,100.023),
    ('huahin',12.57,99.958),
    ('pattaya',12.927,100.877),
    ('danang',16.054,108.243),
    ('nhatrang',12.238,109.196),
    ('phuquoc',10.223,103.957),
    ('bali',-8.69,115.166),
    ('lombok',-8.65,116.32),
    ('langkawi',6.35,99.8),
    ('penang',5.47,100.24),
    ('boracay',11.968,121.924),
    ('elnido',11.182,119.393),
    ('cebu',10.31,123.98),
    ('sanya',18.253,109.512),
    ('okinawa',26.334,127.805),
    ('puntacana',18.582,-68.405),
    ('puertoplata',19.79,-70.687),
    ('varadero',23.155,-81.245),
    ('cayococo',22.51,-78.47),
    ('montegobay',18.471,-77.919),
    ('negril',18.268,-78.348),
    ('cancun',21.161,-86.851),
    ('playadelcarmen',20.629,-87.073),
    ('tulum',20.211,-87.429),
    ('puertovallarta',20.653,-105.225),
    ('barbados',13.1,-59.616),
    ('curacao',12.108,-68.935),
    ('aruba',12.567,-70.043),
    ('nassau',25.06,-77.345),
    ('antigua',17.124,-61.846),
    ('stlucia',14.07,-60.95),
    ('martinique',14.6,-61.073),
    ('guadeloupe',16.229,-61.379),
    ('sanjuan',18.466,-66.106),
    ('turkscaicos',21.787,-72.27),
    ('tamarindo',10.299,-85.84),
    ('bocasdeltoro',9.34,-82.242),
    ('ambergris',17.92,-87.96),
    ('cartagena',10.4,-75.51),
    ('miami',25.79,-80.13),
    ('keywest',24.556,-81.78),
    ('honolulu',21.28,-157.83),
    ('sandiego',32.716,-117.165),
    ('rio',-22.97,-43.183),
    ('salvador',-12.98,-38.47),
    ('fortaleza',-3.73,-38.52),
    ('florianopolis',-27.596,-48.549),
    ('kapstadt',-33.951,18.378),
    ('durban',-29.858,31.021),
    ('saly',14.44,-17.01),
    ('vilanculos',-21.998,35.313),
    ('doha',25.286,51.534),
    ('manama',26.229,50.586),
    ('sydney',-33.891,151.277),
    ('goldcoast',-28.0,153.43),
    ('cairns',-16.87,145.75),
    ('perth',-31.95,115.86),
    ('nadi',-17.798,177.42),
    ('borabora',-16.5,-151.741),
    ('tahiti',-17.535,-149.57),
    ('lapalma',28.68,-17.764),
    ('lagomera',28.09,-17.11),
    ('benidorm',38.535,-0.131),
    ('nerja',36.745,-3.874),
    ('roses',42.262,3.176),
    ('portimao',37.121,-8.538),
    ('tavira',37.127,-7.649),
    ('amalfi',40.634,14.603),
    ('olbia',40.923,9.498),
    ('siracusa',37.075,15.287),
    ('sanvito',38.174,12.735),
    ('ios',36.723,25.283),
    ('karpathos',35.507,27.213),
    ('chios',38.368,26.136),
    ('lesbos',39.1,26.554),
    ('kalamata',37.038,22.113),
    ('sibenik',43.735,15.89),
    ('belek',36.863,31.056),
    ('kemer',36.602,30.56),
    ('ulcinj',41.929,19.224),
    ('vlora',40.466,19.491),
    ('goldstrand',43.283,28.042),
    ('portovecchio',41.591,9.279),
    ('collioure',42.526,3.083),
    ('batumi',41.646,41.64),
]
